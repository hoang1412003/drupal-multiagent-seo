...
- Với công việc service độc lập, admin, auth, connector/site hoặc profile thị trường, bắt buộc đọc `docs/superpowers/specs/2026-08-12-standalone-multiagent-platform-admin-design.md`; đây là thiết kế đã duyệt nhưng chưa phải code hiện hành.
