...
4. For standalone service, admin, authentication, connector/site, or market-profile work, read `docs/superpowers/specs/2026-08-12-standalone-multiagent-platform-admin-design.md`, `docs/superpowers/plans/2026-08-12-standalone-multiagent-platform.md`, and the six post-review decisions in `docs/technical-debt.md` section 8.9. The design/plan has been corrected after review and awaits execution; it is not implemented state. Do not replace the revision-safe result callback with generic JSON:API PATCH or remove hash-v1 rollback compatibility.
