...
4. For standalone service, admin, authentication, connector/site, or market-profile work, read `docs/superpowers/specs/2026-08-12-standalone-multiagent-platform-admin-design.md`, `docs/superpowers/plans/2026-08-12-standalone-multiagent-platform.md`, and the six post-review decisions in `docs/technical-debt.md` section 8.9. **As of 2026-08-14, P1 through P4 are implemented with evidence; P5 hardening/rollout is not.** Do not assume any part of P5 (worker heartbeat, `llm_usage_event`, security headers) already exists. Do not replace the revision-safe result callback with generic JSON:API PATCH or remove hash-v1 rollback compatibility.
