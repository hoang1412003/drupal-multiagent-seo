...
| **B3** | `meta_description` trống, hoặc độ dài ngoài khoảng ~150-160 ký tự | Đếm ký tự |
| **B4** | `title` ngoài khoảng ~50-60 ký tự, **hoặc** viết hoa toàn bộ, **hoặc** gắn năm đã cũ | VD thật trên site: *"LƯU Ý SỬ DỤNG ĐỐI VỚI PIN CELL LFP/GOTION"*, *"...đúng cách 2024"* |
...
### 8.2. Đồng thuận giữa hai người (inter-annotator) - **trần trên của Kappa**

- Người thứ hai (không phải tác giả dự án) gán độc lập 20% mẫu (khoảng 7 bài), chỉ dựa vào tài liệu này, mù với nhãn của người thứ nhất.
- Tính Cohen's Kappa người-người.
- **Con số này là trần trên (ceiling)** để diễn giải Kappa AI-người ở Sprint 3.

Ở Sprint 3 phải báo cáo **hai con số cạnh nhau**:

```
Kappa người - người  = 0.xx   ← trần trên: mức đồng thuận tối đa hợp lý
Kappa AI    - người  = 0.yy
```

Không có con số thứ nhất thì con số thứ hai không diễn giải được. Nếu người-người chỉ đạt 0.65, thì AI đạt 0.60 là **rất tốt**, không phải kém - và ngược lại AI đạt 0.85 khi người-người chỉ 0.65 là dấu hiệu **đáng nghi**, cần kiểm tra rò rỉ dữ liệu.
