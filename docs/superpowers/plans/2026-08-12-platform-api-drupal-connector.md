...
- [ ] **Step 6: RED/GREEN site config theo môi trường**
...
- [ ] **Step 2: RED legacy v1 rollback compatibility**
...
- [ ] **Step 3: RED prepared document/one fetch và stale-write race**
...
- [ ] **Step 4: Implement compatibility delegation**
...
- [ ] **Step 5: Implement worker sequence**
...
- [ ] **Step 1: RED pending/capability/result callback contract**
...
- [ ] **Step 2: Implement metadata feed, capabilities và atomic result writer**
...
- [ ] **Step 3: Cấu hình machine role đủ dùng trước cutover**
...
- [ ] **Step 4: GREEN endpoints và commit ranh giới Drupal trước cutover**
...
- [ ] **Step 5: RED API v1 payload contract**
...
- [ ] **Step 6: Implement hook/controller mapping**
...
- [ ] **Step 7: Preserve save failure isolation**
...
- [ ] **Step 8: GREEN Drupal client tests**
...
- [ ] **Step 9: Commit riêng client cutover**
...
- [ ] **Step 1: Cấu hình site đúng môi trường và import current token**
