...
1. ~~**E1 phải đạt trước.** Bước nhảy 2 điểm chỉ có nghĩa nếu σ < 2.~~ ✅ **đạt (2026-08-04)** — điểm tổng σ = 0,28. **Nhưng có một lưu ý phải mang theo:** riêng Compliance đạt σ = 5,48 trên bài G-002. Điểm tổng ổn định vì trọng số làm loãng dao động đó, không phải vì nó không tồn tại — nên ngưỡng calibrate ra sẽ kém ổn định hơn với các bài mà Compliance dao động mạnh. Làm rubric Compliance trước sẽ cho ngưỡng đáng tin hơn.
